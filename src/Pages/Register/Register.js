...
const Register = () => {
    ...
    return (
        <div className='my-10 px-10'>
            ...
            <form onSubmit={handleSubmit} className='lg:max-w-md md:max-w-md max-w-sm mx-auto'>
                <div className='grid grid-cols-1 gap-4'>
                    <input type="text" required placeholder='Full Name' value={userInfo.name} onChange={handleName} className='outline-none border border-gray-500 focus:border-black pl-4 py-3 rounded-full' />
                    <input type="email" required placeholder='Email' value={userInfo.email} onChange={handleEmail} className='outline-none border border-gray-500 focus:border-black pl-4 py-3 rounded-full' />
                    <input type="password" required placeholder='Password' value={userInfo.password} onChange={handlePassword} className='outline-none border border-gray-500 focus:border-black pl-4 py-3 rounded-full' />
                    <input type="file" name='img' required placeholder='Photo' className='outline-none border border-gray-500 focus:border-black pl-4 py-3 rounded-full' />
                    <select value={userInfo.role} required onChange={handleRole} className='outline-none border border-gray-500 focus:border-black pl-4 py-3 rounded-full' >
                        <option value="Please Select Your Role" selected disabled>Please Select Your Role</option>
